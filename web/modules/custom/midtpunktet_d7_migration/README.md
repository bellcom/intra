# Midtpunktet D7 Migration module

## Module purpose

The aim of this module is to provide migration of the content from Midtpunktet D7 version to OS2Web D8.

## Install

1. Module is part of the repository, and can be installed:
    ```
    drush en midtpunktet_d7_migration
    ```
...
```
drush migrate:import midtpunktet_d7_node_group --limit=5
```
...
```
drush migrate:import midtpunktet_d7_node_group --update
```

Use it with **limit** flag to force update previously imported entities:
```
drush migrate:import midtpunktet_d7_node_group --limit=5 --update
```
